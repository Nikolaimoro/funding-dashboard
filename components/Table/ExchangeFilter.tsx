    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          />
          <div className="absolute z-50 mt-2 bg-[#292e40] border border-[#343a4e] rounded w-[min(92vw,340px)] sm:w-72 p-2 shadow-lg animate-dropdown right-0 sm:left-0 sm:right-auto">
