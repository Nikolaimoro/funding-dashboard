...
export default function BacktesterChart({ chartData, selectedLongEx, selectedShortEx, runToken }: BacktesterChartProps) {
  ...
  return (
    <div className="bg-[#292e40] border border-[#343a4e] rounded-2xl p-6">
      <h2 className="text-lg font-roboto font-normal mb-4 text-gray-200">
        Funding Rates
      </h2>

      {!isLoaded ? (
        <div className="h-96 flex items-center justify-center text-gray-500 rounded-2xl border border-[#343a4e]">
        ...
        <div className="space-y-4">
          ...
          {err && (
            <div className="h-96 flex items-center justify-center text-red-400 rounded-2xl border border-red-800 bg-red-950/20">
              <p>{err}</p>
            </div>
          )}
          ...
          {!loading && !err && rows.length > 0 && (
            <div className="border border-[#343a4e] rounded-2xl p-4 bg-[#292e40] h-96">
              <Chart
