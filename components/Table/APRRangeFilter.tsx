    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="fixed z-50 left-2 right-2 top-20 bg-[#292e40] border border-[#343a4e] rounded-lg max-h-[80vh] overflow-hidden sm:absolute sm:left-0 sm:right-auto sm:top-auto sm:mt-2 sm:w-64 sm:max-h-none p-3 shadow-lg space-y-3 animate-tooltip-zoom">
            <div>
              ...
              <div className="space-y-3 select-none">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    placeholder="Min"
                    className="w-20 bg-[#383d50] border border-transparent rounded-lg px-2 py-1 text-xs text-gray-200 focus:outline-none text-center"
                  />
